...
public: 
 HondaCar() {} 
 void addCars(int i, char cn[], char n[], char e[], char t[], char c[], char 
f[], char p[]) { 
 id = i; 
 strcpy(cname, cn); 
 strcpy(name, n); 
...
std::endl; 
 std::cout << std::endl; 
 std::cout << "S.no  "  " Car  "  "     Engine "  "  Color "  "  Fuel "  "  
Transmission  "  "   Company Price" << 
std::endl; 
 getCar(); 
 std::cout << std::endl; 
 std::cout << "\t\t----------------------*--------------------" << std::endl; 
...
int main() { 
 char ch = ' '; 
 h1[0].addCars(1,"Honda","City", "1298", "Manual", "Silver", "Petrol", 
"1,498,000"); 
 index++; 
 h1[1].addCars(2,"onda", "Civic", "1797", "Manual", "Metal", "Petrol", 
"1,973,000"); 
 index++; 
 
h1[2].addCars(3,"Suzuki","Mehran","796","Manual","Silver","Petrol","5
 75,000"); 
 index++; 
h1[3].addCars(4,"Suzuki ","Cultus","993","Manual","Aque
Blue","Petrol","985,000"); 
index++; 
 
h1[4].addCars(5,"Suzuki","Swift","1300","Manual","Silver","Petrol","1,1
 51,000"); 
index++; 
  
h1[5].addCars(6,"Toyota","Corolla","1298","Manual","Blue","Petrol","1,
 554,000"); 
index++; 
 
h1[6].addCars(7,"Toyota","Hilux","N/A","Manual","White","Petrol","1,7
 79,200"); 
index++; 
h1[7].addCars(8,"Toyota","Prado","2982","Manual","Green","Petrol","1
 1,99,000"); 
 
index++; 
h1[8].addCars(9,"Toyota","Camry","2362","Manual","Black","Petrol","7,
 846,000"); 
index++; 
...
"Petrol","2,549,000"); 
index++; 
h1[10].addCars(11,"Toyota","Altis","1598","Auto","Mica","Petrol","2,10
 4,500"); 
index++; 
h1[11].addCars(12,"Suzuki","Liana","1298","Any","Gray","Petrol","1,43
 2,000"); 
index++; 
 // Add more cars here 
 while (1) { 
 std::cout << std::endl << std::endl; 
 std::cout << "\n\t\t\tWelcome to Car Showroom" << std::endl << 
std::endl; 
 std::cout << "*" << std::endl; 
...
std::endl; 
 ...
 std::cout << "Do you want to insert a new car? Press Yes(y) or No(n)" 
<< std::endl 
<< std::endl; 
 std::cin >> in; 
 } while (in == 'y'); 
 break; 
 case '2': 
 std::cout << "S.no Car       Engine    Color     Fuel      Transmission    
Company   Price" 
<< std::endl; 
 ShowCars(); 
 break; 
...
void BuyCar() { 
 ...
 std::cout << "Press y to purchase a car or n to goto Main menu" << 
std::endl; 
 std::cin >> c; 
 if (c == 'y' || c == 'Y') { 
...
void SellCars() { 
 ...
 cst[i].showCustInfo(); 
 if (i < index) { 
 std::cout << "\nS.no  Car      Engine      Color   Fuel    Transmission     
Company     Price" << 
std::endl; 
 h1[i].getCar(); 
 } 
